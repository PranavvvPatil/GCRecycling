  ...
  return (
    <section className='container mx-auto mb-8 mt-12' id='review'>
        <motion.div initial="hidden" whileInView="show" variants={containerVariants} viewport={{once:true}} className="flex flex-col">
            <motion.p variants={itemVariants} className='mb-10 text-3xl font-light leading-normal tracking-tighter lg:mx-40 lg:mt-40 lg:text-[3.5 rem]'>
                {REVIEW.content}
            </motion.p>
        ...
        <motion.div initial="hidden" whileInView="show" variants={containerVariants} viewport={{once:true}} className="mt-14 flex flex-col items-center justify-center gap-2 md:flex-row">
